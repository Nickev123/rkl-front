...
const About = () => (
  <div id="about" className="flex flex-col items-center px-5p text-white mb-12">
    ...
    <div
      ...
      style={{
        backgroundImage: `url('/assets/about/basketball.jpg')`,
        backgroundRepeat: "no-repeat",
        backgroundSize: "100% auto",
      }}
      data-aos="fade"
    >
      <div className="w-auto lg:w-max flex flex-col justify-center ml-auto px-2 sm:px-20 h-full">
        <h1
        ...
        <h3
          className="font-sans mb-8 sm:mb-12 xl:mb-40"
